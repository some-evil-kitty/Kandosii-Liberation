...
if ( dojump > 0 ) then {
    ...
    if (player call jen_jetpacks_core_fnc_hasJetpack) then {player setunitfreefallheight 1000000};
    halojumping = true;
    sleep 0.1;
    ...
    if (( _backpack != "" && _backpack != "B_Parachute" ) && !(player call jen_jetpacks_core_fnc_hasJetpack)) then {
